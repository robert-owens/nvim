vim.api.nvim_create_user_command('Restart', function()
  ...
  vim.cmd 'qa' -- quit all
  os.execute 'start nvim' -- relaunch Neovim
end, {})
...
vim.cmd 'cd C:/Users/rowens04/Documents/Notes'
-- See `:help mapleader`
...
-- vim.keymap.set('n', '<leader>zd', '<cmd>Telekasten goto_today<CR>', { desc = "Telekasten: Go to today's note" })
-- vim.keymap.set('n', '<leader>zw', '<cmd>Telekasten goto_thisweek<CR>', { desc = "Telekasten: Go to this weeks's note" })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      require('tokyonight').setup {
        ...
        styles = {
          comments = { italic = false }, -- Disable italics in commentos
...
require('telekasten').setup {
  home = vim.fn.expand 'c:/Users/rowens04/Documents/Notes/', -- Put the name of your notes directory here
  template_new_daily = 'c:/Users/rowens04/Documents/Notes/templates/daily.md',
  template_new_weekly = 'c:/users/rowens04/document/notes/templates/weekly.md',
